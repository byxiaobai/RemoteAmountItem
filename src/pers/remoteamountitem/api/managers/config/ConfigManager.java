package pers.remoteamountitem.api.managers.config;
...
import pers.remoteamountitem.RemoteAmountItem;
import pers.remoteamountitem.api.utils.StringUtil;
...
public class ConfigManager {
	...
	private static class PluginUtil {
		public static Plugin getPlugin() {
			return RemoteAmountItem.getPlugin();
		}
	}
}
